...
//    tableView.delegate = sut
  ...
  func test_NumberOfRows_InFirstSection_IsToDoCount() {
    ...
    // We, as developers, need to tell the table view that the data source has
    // changed by calling reloadData().
  ...
  func test_SelectingACell_SendsNotification() {
    ...
    expectation( forNotification:
      NSNotification.Name(rawValue: "ItemSelectedNotification"),
